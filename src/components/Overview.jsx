...
//   return (
//     <div className='bg-[#F2F4F7]'>
//       <div className='w-[90%] m-auto flex flex-col sm:flex-row items-center justify-between py-2'>
//         <div className='flex flex-col sm:flex-row items-center gap-[16px] sm:gap-[23px]'>
//           <div className='flex items-center gap-[6px]'>
//             <span>{icons.location}</span>
//             <p className='text-[14px] leading-[14px] font-normal text-blackMain'>
//               {t("overview.city")}
...
//           </p>
//         </div>
//         <p className='text-[#8B8E99] text-[14px] leading-[14px] font-normal mt-2 sm:mt-0'>
//           {t("overview.message")}
//         </p>
//         <div className='flex flex-col sm:flex-row items-center gap-[16px] sm:gap-[26px] mt-2 sm:mt-0'>
//           <div className='flex flex-col sm:flex-row items-center gap-[8px] sm:gap-[16px]'>
//             <p className='text-[#595B66] text-[14px] leading-[14px] font-medium'>
//               {t("overview.faq")}
//             </p>
//             <p className='text-[#595B66] text-[14px] leading-[14px] font-medium'>
